...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Debug")
	float DebugCircleHeightOffset = 0.0f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Visual")
	TObjectPtr<UMaterialParameterCollection> VisualParameterCollection;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Visual")
	FName CenterParameterName = "CircleCenter";

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Visual")
	FName RadiusParameterName = "CircleRadius";

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Visual")
	float EdgeTransitionWidth = 200.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Complete")
	TSubclassOf<AActor> ActorToSpawnOnComplete;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Poison Circle|Complete")
	FVector SpawnLocationOnComplete = FVector::ZeroVector;
...
private:
	...
	void OnAllShrinkEventsComplete();
